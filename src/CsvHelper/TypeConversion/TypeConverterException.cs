...
namespace CsvHelper.TypeConversion
{
	...
	public class TypeConverterException : CsvHelperException
	{
		...
		public TypeConverterException( ITypeConverter typeConverter, MemberMapData memberMapData, string text, IReadingContext context ) : base( context )
		{
		...
		public TypeConverterException( ITypeConverter typeConverter, MemberMapData memberMapData, object value, IWritingContext context ) : base( context )
		{
			TypeConverter = typeConverter;
			MemberMapData = memberMapData;
			Value = value;
		...
		public TypeConverterException( ITypeConverter typeConverter, MemberMapData memberMapData, string text, IReadingContext context, string message, Exception innerException ) : base( context, message, innerException )
		{
			TypeConverter = typeConverter;
			MemberMapData = memberMapData;
			Text = text;
		...
		/// <param name="message">The error message that explains the reason for the exception.</param>
		/// <param name="innerException">The exception that is the cause of the current exception, or a null reference (Nothing in Visual Basic) if no inner exception is specified.</param>
		public TypeConverterException( ITypeConverter typeConverter, MemberMapData memberMapData, object value, IWritingContext context, string message, Exception innerException ) : base( context, message, innerException )
		{
			TypeConverter = typeConverter;
			MemberMapData = memberMapData;
			Value = value;
