...
namespace CsvHelper.TypeConversion
{
	...
	public interface ITypeConverter
	{
		...
		string ConvertToString( object value, IWriterRow row, PropertyMapData propertyMapData );
		...
		object ConvertFromString( string text, IReaderRow row, PropertyMapData propertyMapData );
	}
}
