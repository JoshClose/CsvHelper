...
public class RecordManager
{
	...
	{
		if (recordCreatorFactory is null) throw new InvalidOperationException("The record creator factory is null.");
	...
	{
		if (recordHydrator is null) throw new InvalidOperationException("The record hydrator is null.");
	...
	{
		if (recordWriterFactory is null) throw new InvalidOperationException("The record creator factory is null.");
