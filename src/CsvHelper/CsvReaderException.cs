...
namespace CsvHelper
{
	...
	public class CsvReaderException : CsvHelperException
	{
		...
		public CsvReaderException( ReadingContext context, string message ) : base( context, message ) { }
		...
		public CsvReaderException( ReadingContext context, string message, Exception innerException ) : base( context, message, innerException ) { }
	}
}
