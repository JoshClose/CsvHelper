...
namespace CsvHelper
{
	...
	/// </summary>
	public class CsvWriter<TSerializer> : ICsvWriter<TSerializer> where TSerializer : ISerializer
	{
		...
		/// Gets the serializer.
		/// </summary>
		public virtual TSerializer Serializer { get; }
		...
		public CsvWriter( TSerializer serializer, bool leaveOpen )
		{
			if( serializer == null )
			{
