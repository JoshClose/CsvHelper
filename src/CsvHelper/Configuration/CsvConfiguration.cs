...
namespace CsvHelper.Configuration
{
    ...
    public class CsvConfiguration
    {
        ...
        /// <summary>
        /// Gets the array of characters that result in the string being quoted.
        /// </summary>
        /// <value>
        /// The new array of characters
        /// </value>
        public virtual char[] MustQuoteCharacters { get; private set; }
        ...
        /// </value>
        public virtual string QuoteString { get; private set; }
        /// <summary>
        ...
        /// </value>
        public virtual string DoubleQuoteString { get; private set; }
        ...
        /// <summary>
        /// Builds the array of characters that must be escaped, including the delimiter if it is possible.
        /// </summary>
        private void BuildEscapedCharacters()
        {
            if (Delimiter.Length == 1)
                MustQuoteCharacters = new char[] { '\r', '\n', Delimiter[0] };
            else
                MustQuoteCharacters = new char[] { '\r', '\n' };
        }

        /// <summary>
        /// Builds the prepared string versions of the quote character.
        /// </summary>
        private void BuildQuoteStrings()
        {
            QuoteString = quote.ToString();
            DoubleQuoteString = String.Concat(QuoteString, QuoteString);
        }
    }
}
