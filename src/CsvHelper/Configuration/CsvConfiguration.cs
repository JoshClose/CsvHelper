...
namespace CsvHelper.Configuration
{
    ...
    public class CsvConfiguration
    {
...
#endif
        private IContractResolver contractResolver = null;
        ...
        /// <summary>
        /// Gets or sets the contract resolver that allows for creating
        /// concreate instances from interfaecs via the DI framework of your
        /// choice
        /// </summary>
        ...
        {
            var map = ReflectionHelper.CreateInstance<TMap>(ContractResolver);
        ...
        public virtual CsvClassMap RegisterClassMap( Type classMapType )
        {
            ...
            var map = (CsvClassMap)ReflectionHelper.CreateInstance( ContractResolver, classMapType );
            RegisterClassMap( map );
        ...
        public virtual void RegisterClassMap( CsvClassMap map )
        {
            ...
            if( map.ContractResolver == null ) map.ContractResolver = ContractResolver;
        ...
        public virtual CsvClassMap AutoMap(Type type )
        {
            ...
            var map = (CsvClassMap)ReflectionHelper.CreateInstance( ContractResolver, mapType );
