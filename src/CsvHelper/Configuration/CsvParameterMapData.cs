...
namespace CsvHelper.Configuration
{
    ...
    public class CsvParameterMapData
    {
		/// <summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CsvParameterMapData"/> class.
		/// </summary>
		/// <param name="parameter">The constructor parameter.</param>
		public CsvParameterMapData( ParameterInfo parameter )
		{
			Parameter = parameter;
		}
	}
